...
class TradeRecordController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('index.tradeRecord.index', [
    ...
    public function create()
    {
        ...
        return view('index.tradeRecord.create', [
            'categorys' => $categorys
        ]);
    }
    ...
    public function store(Request $request)
    {
        ...
        Validator::make($input, [
            'order_number' => ['required', 'max:255', 'unique:trade_records,order_number'],
            'menufactoring_number' => ['required', 'max:255', 'unique:trade_records,menufactoring_number'],
    ...
    public function show($id)
    {
        ...
        return view('index.tradeRecord.show', [
    ...
    public function edit($id)
    {
        ...
        return view('index.tradeRecord.edit', [
            'tradeRecord' => $tradeRecord,
            'categorys' => $categorys
        ]);
    }
