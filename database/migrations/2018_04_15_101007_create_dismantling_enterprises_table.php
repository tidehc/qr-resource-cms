 ...
 * 拆解企业表
 */
class CreateDismantlingEnterprisesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('dismantling_enterprises', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('dismantling_enterprises');
    }
}
