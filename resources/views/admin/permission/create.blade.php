...
@section('main')
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="tile">
        <form action="{{ url('admin/entrust/permission') }}" method="post">
          {{ csrf_field() }}
          <div class="form-group row">
            <label class="control-label col-md-2" for="name">权限名：</label>
            <div class="col-md-10">
              <input class="form-control" id="name" name="name" type="text" placeholder="请输入权限名称" required=""><small class="form-text text-muted">推荐英文名</small>
              </div>
          </div>
          <div class="form-group row">
          ...
          <div class="form-group row">
            ...
            <div class="col-md-10">
              <input class="form-control" id="description" name="description" type="text" placeholder="请输入描述信息(选填)"><small class="form-text text-muted">该权限的详细描述</small>
              </div>
          </div>
          <div class="form-group row">
